...
仕事や家事で運動を逃しがちな日に、できなかったことを責めず、理由の記録と20〜60秒の小さな行動で立て直す習慣化アプリです。ペットの状態と振り返りを通じて、無理のない再開を後押しします。
...
3. 理由に応じた20〜60秒の「反撃」タイマーを実行する
4. 直近7日・30日の傾向、最後の反撃、反撃率を振り返る
5. 記録の傾向と連続記録を、ペットの元気・ご機嫌・空腹・成長として表示する
